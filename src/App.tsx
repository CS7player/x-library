import './App.css';
import { Button, ButtonLib, CheckBox, CheckBoxLib, DatePicker, DatePickerLib, TextField, TextFieldLib } from './library';
import { Icons } from './library/utils/icon';
...
function App() {
  ...
  printBtn.setStartIcon(<Icons.Clock />);
